...
import styles from './RNSpinner.style';
      ...
      <View style={[styles.container,
        ...
        <TouchableOpacity
          ...
          <Text style={[styles.btnText,
              { color: this.props.buttonTextColor, fontSize: this.props.btnFontSize },this.props.plusMinusStyle]}>-</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Text style={[styles.btnText,
              ...
              }, this.props.plusMinusStyle]}>+</Text>
        </TouchableOpacity>
      </View>
    )
  }
